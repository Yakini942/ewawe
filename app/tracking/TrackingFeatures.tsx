        ...
        <div className="mt-16 text-center">
          <div className="bg-white rounded-2xl p-8 shadow-lg max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-sky-400 to-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:shadow-lg transition-all duration-300 cursor-pointer whitespace-nowrap">
                Contact Support
              </button>
              <button className="border border-sky-400 text-sky-600 px-8 py-3 rounded-lg font-semibold hover:bg-sky-50 transition-all duration-300 cursor-pointer whitespace-nowrap">
                Live Chat
              </button>
            </div>
          </div>
